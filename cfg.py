config = {
    'bsds500': {'data_root': '/run/user/1000/gvfs/smb-share:server=192.168.0.253,share=data/Master/train/stableEdges2/',
                #'data_lst': 'train_pair_bsds_aug_mix_aug.lst',
                'data_lst': 'auto_generated_train_train_pair.lst',
                'mean_bgr': [104.00699, 116.66877, 122.67892],
                'yita': 0.3,
                'validation': 1, # enable: 1, otherwise 0
                'val_lst': 'auto_generated_val_train_pair.lst' # optional, rel to data_root, otherwise will be generated automatically
                },
...
config_test = {
    'bsds500': {'data_root':'/run/user/1000/gvfs/smb-share:server=192.168.0.253,share=data/Master/train/stableEdgesTest2/all_rgb/',
                #'data_root': '/run/user/1000/gvfs/smb-share:server=192.168.0.253,share=data/Master/datasets/bsr_bsds500/BSR/BSDS500/data/images/test_png/',
                'data_lst': 'test.lst',
                'mean_bgr': [104.00699, 116.66877, 122.67892],
                'yita': 0.5},
